...
gpioW1=19 #luz de fundo
gpioW2=26 #luz branca intensa
gpioR=20
gpioG=16
...
def measureCamera():
        ...
        for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
            ...
            if(status=='medicao'):
                ...
                gpio.output(gpioR,gpio.LOW)
                gpio.output(gpioG,gpio.LOW)
                crop=outputW[66:196,150:150+16]
                cropR=outputR[66:196,150:150+16]
                cropG=outputG[66:196,150:150+16]
